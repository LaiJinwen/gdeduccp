<%@ page language="java"
	import="java.util.*,java.net.*,com.zhuozhengsoft.pageoffice.*"
	pageEncoding="utf-8"%>
<%
...
System.out.println(request.getContextPath()+"/doc/"+path+"/"+filename);

//编码子目录（含中文）
String docno=java.net.URLEncoder.encode(path,"utf-8");
String filename2=java.net.URLEncoder.encode(filename,"utf-8");
//设置保存页面
poCtrl.setSaveFilePage("SaveFile.jsp?docno="+ docno+"&filename="+filename2);
//打开Word文档"/gdeduccp/doc/"+
poCtrl.webOpen(request.getContextPath()+"/doc/"+path+"/"+filename,OpenModeType.docNormalEdit,"广东省教育工委");
%>
...
<body>
	...
	<div style=" text-align:center; margin:10px; background-color:#D19275; color:White; padding:8px;"><h1>广东教育工委党建工作文档</h1></div>
    <!-- HTML页面布局 -->
    <div id = "tab">
        <ul>
