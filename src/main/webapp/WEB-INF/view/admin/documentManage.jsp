...
<div id="page-wrapper">
	...
	<div id="page-inner">
		<form role="form" class="form-inline" name="form1"
			action="${pageContext.request.contextPath}/admin/documentSearch" method="post">
			<div class="row">
				<div class="col-xs-12">
									...
									<c:set var="recno" value="${(docs.currPage-1)*docs.pageSize}" />
										<c:forEach var="doc" items="${docs.lists}">
											...
											<c:set var="recno" value="${recno+1}" />
												...
												<td><a href="/gdeduccp/doc/${doc.documentNo}/${fn:substringBefore(doc.accessory,'.')}.docx"
													target=_blank>下载</a> &nbsp;&nbsp; <a
													href="/gdeduccp/doc/${doc.documentNo}/${fn:substringBefore(doc.accessory,'.')}.html"
