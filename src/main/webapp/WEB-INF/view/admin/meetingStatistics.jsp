...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="page-inner">
		<form role="form" class="form-inline" name="form1"
			action="${pageContext.request.contextPath}/admin/meetingStatBySchool" method="post">
			<div class="row">
				<div class="col-xs-12">
								...
								<div class="form-group col-md-6">
										...
										<div class="col-sm-10">
											<input type="text" class="form-control" id="meetingNo"
												name="meetingNo" value="${meetingNo}"
												placeholder="会议编号">
										</div>
									</div>
									
 									<div class="form-group col-md-6">
										<label for="organizationName" class="col-sm-2 control-label">高校名称</label>
										<div class="col-sm-10">
										...
										<div class="col-sm-10">
											...
											<div
												...
												<input type="checkbox" id="checkbox-fa-light-1" value="本科院校"
													name="schoolLevel" 
                                                 <c:if test="${fn:contains(schoolLevel,'本科院校')==true}">
													checked	 
										          </c:if>
                                                 > 
                                                 <label
											...
											<div
												...
												<input type="checkbox" id="checkbox-fa-light-2" value="专科院校"
													name="schoolLevel" 
                                            <c:if test="${fn:contains(schoolLevel,'专科院校')==true}">
													checked	 
										          </c:if> 
                                               > <label
											...
											<div
												...
												<input type="checkbox" id="checkbox-fa-light-3" value="成人高校"
													name="schoolLevel" 
                                           <c:if test="${fn:contains(schoolLevel,'成人高校')==true}">
													checked	 
										          </c:if> 
                                              > <label
											...
											<div
												...
												<input type="checkbox" id="checkbox-fa-light-4" value="研究生"
													name="schoolLevel" 
                   <c:if test="${fn:contains(schoolLevel,'研究生')==true}">
													checked
										          </c:if> 
> <label
											...
											<div
												...
												<input type="checkbox" id="checkbox-fa-light-4" value="其他"
													name="schoolLevel" 
                   <c:if test="${fn:contains(schoolLevel,'其他')==true}">
													checked	 
										          </c:if> 
> <label
 ...
 <c:if test="${fn:contains(organizationType,'公办')==true}">
													checked
										          </c:if> 
> <label
											...
											<div
												...
												<input type="checkbox" id="checkbox-fa-light-2" value="民办"
													name="organizationType" 
 <c:if test="${fn:contains(organizationType,'民办')==true}">
													checked
										          </c:if> 
> <label
											...
											<div
												...
												<input type="checkbox" id="checkbox-fa-light-3" value="独立学院"
													name="organizationType" 
 <c:if test="${fn:contains(organizationType,'独立学院')==true}">
													checked
										          </c:if> 
> <label
											...
											<div
												...
												<input type="checkbox" id="checkbox-fa-light-4" value="合作办学"
													name="organizationType" 
 <c:if test="${fn:contains(organizationType,'合作办学')==true}">
													checked
										          </c:if> 
> <label
										...
										<div class="col-sm-10">
											<div
												...
												<input type="checkbox" id="checkbox-fa-light-1" value="省工委"
													name="belong" 
 <c:if test="${fn:contains(belong,'省工委')==true}">
													checked
										          </c:if> 
> <label
											...
											<div
												...
												<input type="checkbox" id="checkbox-fa-light-2" value="其他"
													name="belong" 
 <c:if test="${fn:contains(belong,'其他')==true}">
													checked
										          </c:if> 
> <label
									...
									<div class="form-group col-md-12">
										...
										<input type='hidden' id='page' name='page'
											value='${docs.currPage}' />
										 <a class="btn btn-primary navbar-btn" href="${pageContext.request.contextPath}/doc/xls/meetingStatistics.xls" download="${pageContext.request.contextPath}/doc/xls/meetingStatistics.xls"><i class="ti-download"></i>下载excle文件</a>	
								...
								<table class="table table-striped table-bordered table-hover" style="width:600">
									<thead>
										<tr>
											...
											<th class="text-center">应参次数</th>
											<th class="text-center">已参次数</th>
											<th class="text-center">参加人次</th>
