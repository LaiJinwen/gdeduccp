	...
	<ul class="nav navbar-top-links navbar-right">
		<span class="welcome-msg">欢迎您！${userName}</span>
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="#" onclick="showDialog('${pageContext.request.contextPath}/intoUserInfo.do')"><i class="fa fa-user fa-fw"></i>用户资料修改</a>
                        </li>
                        <li class="divider"></li>
                         <li><a href="${pageContext.request.contextPath}/school/intoOrganizationModifyUi"><i class="fa fa-user fa-fw"></i> 单位资料修改</a>
                        </li>
                        <li class="divider"></li>                       
