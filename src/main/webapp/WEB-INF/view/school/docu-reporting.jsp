                    ...
                    <div class="col-xs-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" id="form1"  action = "<%=request.getContextPath() %>/school/uploadDocument.do?docId=${docId}" method="post"  enctype ="multipart/form-data">
                                    ...
                                    <button type="button" class="btn btn-md btn-primary col-md-offset-2" onclick="startPublish()">确定上报</button>
                                </form>
                            </div>
                        </div>
                    </div>
