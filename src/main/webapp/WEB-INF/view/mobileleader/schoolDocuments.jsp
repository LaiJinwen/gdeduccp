...
<body>
	...
	<c:forEach var="document" items="${documents}">
		<ul class="ui-list ui-list-function ui-border-tb">
			...
			<a href="${pageContext.request.contextPath}/doc/${document.documentno}/${fn:substringBefore(document.accessory,'.')}backup.html">
					<div class="ui-list-info">
						<h4 class="ui-nowrap">${document.title}</h4>
						<div id="lil-info">
	                     ...
	                     <p style="float:left; color:${fontcolor}" class="ui-nowrap">${document.documentstate} &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						   </p>								
							</div>
						</div>
					</div>
